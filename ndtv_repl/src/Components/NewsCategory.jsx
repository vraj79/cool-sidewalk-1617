      ...
      <div className={style.aefl} style={{ marginTop: "-70px" }}>
        <div>
          ...
          <div>
            ...
            height='200px'
              ...
              alt=""
            />
            <h2 style={{position:'relative',bottom:'90px',padding:'1%',color:'white'}} >Tata Tiago EV Launched In India; Prices Here</h2>
          </div>
          ...
          <div className={style.education}>
            <p>
            Last Lamborghini Aventador Rolls Out Of Production
            </p>
            <img
        ...
        <div>
          ...
          <div className={style.education}>
            ...
            <img width='100px' height='100px' src="https://cache.careers360.mobi/media/presets/625X300/article_images/2022/9/24/CUET-PG-result_2022-cutoff-scores-featured-Images.jpg?im=FaceCrop,algorithm=dnn,width=80,height=60" alt="" />
          </div>
          <hr />
          <div className={style.education}>
            <p>CEED, UCEED 2023 Websites Launched; Registration Starts On September 30</p>
            <img width='100px' height='100px' src="https://cache.careers360.mobi/media/presets/625X300/article_images/2022/9/24/ceed_uceed-featured-image.jpg?im=FaceCrop,algorithm=dnn,width=80,height=60" alt="" />
          </div>
          <hr />
          <div className={style.education}>
            <p>JEECUP Counseling Round 4 Registration Starts Today, Check Steps To Apply</p>
            <img width='100px' height='100px' src="https://cache.careers360.mobi/media/presets/625X300/article_images/2022/9/24/JEECUP-Counselling-2022-Round-4-Registration-Featured-Image.jpg?im=FaceCrop,algorithm=dnn,width=80,height=60" alt="" />
          </div>
          <hr />
          <div className={style.education}>
            <p>West Bengal WBMCC NEET PG 2022 Counselling Registration Begins</p>
            <img width='100px' height='100px' src="https://cache.careers360.mobi/media/presets/625X300/article_images/2022/9/23/mbbs-featured-image.jpg?im=FaceCrop,algorithm=dnn,width=80,height=60" alt="" />
          </div>
        </div>
        <div>
          <button style={{ backgroundColor: "black", borderRadius: "5px" }}>
          ...
          <div>
            ...
            height='200px'
              ...
              alt=""
            />
            <h2 style={{position:'relative',bottom:'90px',padding:'1%',color:'white'}} >7 Crispy Potato Snacks You Can Rustle Up For Evening Tea</h2>
          </div>
          <div style={{marginTop:"-95px"}}>
          <div className={style.education}>
            <p>
          ...
          <div className={style.education}>
            <p>
            5 Quick And Healthy Lunch Box Ideas For Kids
            </p>
            <img
        ...
        <div>
          ...
          <div className={style.education}>
            <p>Don't Miss These Top 8 Deals On Gorgeous Silk Sarees At Up To 70% Off</p>
            <img width='100px' height='100px' src="https://c.ndtvimg.com/2022-09/9v2moe4g_sarees240_120x90_28_September_22.jpg?downsize=80:60" alt="" />
          </div>
          <hr />
          <div className={style.education}>
            <p>Grab These Amazing Deals On Water Purifiers From Eureka, Kent And More</p>
            <img width='100px' height='100px' src="https://c.ndtvimg.com/2022-09/ljlk0cb_appliances240_120x90_28_September_22.jpg?downsize=80:60" alt="" />
          </div>
          <hr />
          <div className={style.education}>
            <p>Tamannaah Bhatia's Red Floral Saree Gives Ethnic Wear A Modern Touch</p>
            <img width='100px' height='100px' src="https://c.ndtvimg.com/2022-09/3afr89p8_tamannaah-bhatia_240x180_28_September_22.jpg?downsize=80:60" alt="" />
          </div>
          <hr />
          <div className={style.education}>
            <p>From 24K Lip Gloss To Upcycled Plastic Watches, These 7 Launches Are It</p>
            <img width='100px' height='100px' src="https://c.ndtvimg.com/2022-09/dvk677fg_new-launch_240x180_28_September_22.jpg?downsize=80:60" alt="" />
          </div>
        </div>
      </div>
    </div>
